...
if(isset($_POST['title']) && isset($_FILES['image-file']) && isset($_POST['content'])){
    if(isset($_SESSION['user_id'])){
        ...
        if (move_uploaded_file($picture['tmp_name'], $path . '/' . $picture['name'])) {
            $query = "INSERT INTO news(title, image, createdate, content,user_id)
            VALUES('$title', '$path/{$picture['name']}', NOW(),'$content',$user_id)";
...
<body>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="title">
            ...
            <input id="title" name="title" type="text" placeholder="Tiêu đề bài viết">
        </div>
        <div class="link-img">
        ...
        <div class="content">
            ...
            <textarea name="content" id="content" cols="30" rows="35" placeholder="Nội dung bài viết"></textarea>
        </div>
        <div class="btn">
            <button>Thêm</button>
        </div>
